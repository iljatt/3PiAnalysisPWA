...
void print1DimCompDataMC()
{
  ...
  const char *datafilename = "histos_data_spring2017_precuts_diffpipluscut_piminuscut_deltacut.root";
  const char *mcfilename = "histos_mc_spring2017_precuts_diffpipluscut_piminuscut_deltacut.root";
  Double_t posl,posr;
