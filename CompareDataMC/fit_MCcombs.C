...
void fit_MCcombs()
{
  ...
  TFile *data_histfile = TFile::Open("histos_data_spring2017_after_slowpiminuscut.root","READ");
  TFile *mc_sig_histfile = TFile::Open("histos_mc_spring2017_after_slowpiminuscut.root","READ");
  TFile *mc_bg2_histfile = TFile::Open("histos_mc_bgcomb2_spring2017_after_slowpiminuscut.root","READ");
  TFile *mc_bg3_histfile = TFile::Open("histos_mc_bgcomb3_spring2017_after_slowpiminuscut.root","READ");
  TFile *mc_bg4_histfile = TFile::Open("histos_mc_bgcomb4_spring2017_after_slowpiminuscut.root","READ");
  TFile *mc_bg5_histfile = TFile::Open("histos_mc_bgcomb5_spring2017_after_slowpiminuscut.root","READ");
