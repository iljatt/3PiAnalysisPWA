...
void fit_single(const char *var, TFile *data_histfile, TFile *mc_sig_histfile, TFile *mc_bg2_histfile, TFile *mc_bg3_histfile, TFile *mc_bg4_histfile, TFile *mc_bg5_histfile){
  ...
  var_mcsig->Scale(var_data->Integral()/var_mcsig->Integral());
  var_mcbg2->Scale(var_data->Integral()/var_mcbg2->Integral());
  var_mcbg3->Scale(var_data->Integral()/var_mcbg3->Integral());
  var_mcbg4->Scale(var_data->Integral()/var_mcbg4->Integral());
  var_mcbg5->Scale(var_data->Integral()/var_mcbg5->Integral());



  Int_t num = 5;
  Int_t NData = var_data->GetEntries();
  Double_t DataIntegral = var_data->Integral();
