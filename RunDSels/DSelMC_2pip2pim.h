#ifndef DSelMC_2pip2pim_h
#define DSelMC_2pip2pim_h
...
class DSelMC_2pip2pim : public DSelector
{
	public:

		DSelMC_2pip2pim(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelMC_2pip2pim(){}
	...
	ClassDef(DSelMC_2pip2pim, 0);
};

void DSelMC_2pip2pim::Get_ComboWrappers(void)
{
	//Step 0
