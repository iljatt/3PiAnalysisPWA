#ifndef DSelData_2pip2pim_h
#define DSelData_2pip2pim_h
...
class DSelData_2pip2pim : public DSelector
{
	public:

		DSelData_2pip2pim(TTree* locTree = NULL) : DSelector(locTree){}
                virtual ~DSelData_2pip2pim(){}
	...
	ClassDef(DSelData_2pip2pim, 0);
};

void DSelData_2pip2pim::Get_ComboWrappers(void)
{
	//Step 0
