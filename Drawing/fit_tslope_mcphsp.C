...
void fit_tslope_mcphsp()
{
  ...
  var_mc_slope14->Scale(var_data->Integral(lfit,rfit)/var_mc_slope14->Integral(lfit,rfit));
  var_mc_slope12->Scale(var_data->Integral(lfit,rfit)/var_mc_slope12->Integral(lfit,rfit));
  var_mc_slope10->Scale(var_data->Integral(lfit,rfit)/var_mc_slope10->Integral(lfit,rfit));
  var_mc_slope8->Scale(var_data->Integral(lfit,rfit)/var_mc_slope8->Integral(lfit,rfit));
  var_mc_slope6->Scale(var_data->Integral(lfit,rfit)/var_mc_slope6->Integral(lfit,rfit));
  var_mc_slope4->Scale(var_data->Integral(lfit,rfit)/var_mc_slope4->Integral(lfit,rfit));
  var_mc_slope3->Scale(var_data->Integral(lfit,rfit)/var_mc_slope3->Integral(lfit,rfit));
  var_mc_slope2->Scale(var_data->Integral(lfit,rfit)/var_mc_slope2->Integral(lfit,rfit));
  var_mc_slope1p5->Scale(var_data->Integral(lfit,rfit)/var_mc_slope1p5->Integral(lfit,rfit));
  var_mc_slope1->Scale(var_data->Integral(lfit,rfit)/var_mc_slope1->Integral(lfit,rfit));
