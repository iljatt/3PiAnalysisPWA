...
void printThreeCutsImpact()
{


  const char *data1filename = "histos_data_spring2017_precuts_diffpipluscut_deltacut_fourpionscut_piminuscut.root";
  const char *data2filename = "histos_data_spring2017_precuts_diffpipluscut_deltacut_fourpionscut_piminuscut1p0.root";
  ...
  Double_t posl,posr;
   ...
   for (int i=0; i<25; i++){
     ...
     outpdf = "ShowImpact3cuts/pic_"+variables[i]+".pdf";
