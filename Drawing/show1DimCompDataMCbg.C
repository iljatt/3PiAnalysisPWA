...
void setstyle(TH1D *dhisto, TH1D *mchisto, TH1D *mcbghisto, TLegend *leg)
{
    ...
    leg->AddEntry(mcbghisto,"  MC bg#5","l");
...
void show1DimCompDataMCbg()
{

  const char *datafilename = "histos_data_spring2017_precuts_diffpipluscut_deltacut_fourpionscut_piminuscut.root";
  const char *mcfilename = "histos_mcw_spring2017_precuts_diffpipluscut_deltacut_fourpionscut_piminuscut.root";
  const char *mcbgfilename = "CombBGs/histos_mc_bgcomb5_spring2017_precuts_diffpipluscut_deltacut_fourpionscut_piminuscut.root";
  ...
  Double_t posl,posr;
   ...
   for (int i=0; i<17; i++){
     ...
     outpdf = "Comp_DataMCbg5/pic_"+variables[i]+".pdf";
